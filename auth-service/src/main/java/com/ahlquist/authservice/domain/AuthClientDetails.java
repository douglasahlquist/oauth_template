package com.ahlquist.authservice.domain;
...
public class AuthClientDetails implements ClientDetails {
	...
	//TODO (dahlquist) : suppress warnings
	...
	@Override
	//TODO (dahlquist) : always returns true
	...
	@Override
	//TODO (dahlquist) : always returns false
	...
	@Override
	//TODO (dahlquist) : currently this returns a null FIX!
