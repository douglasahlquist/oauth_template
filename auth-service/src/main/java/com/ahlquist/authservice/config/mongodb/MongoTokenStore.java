...
import com.ahlquist.authservice.domain.MongoAccessToken;
import com.ahlquist.authservice.domain.MongoRefreshToken;
...
public class MongoTokenStore implements TokenStore {
	...
	public Collection<OAuth2AccessToken> findTokensByClientIdAndUserName(String clientId, String username) {
		return findTokensByCriteria(
				Criteria.where(MongoAccessToken.CLIENT_ID).is(clientId).and(MongoAccessToken.USER_NAME).is(username));
	}
