package com.ahlquist.authservice.config.mongodb.changelogs;

import com.ahlquist.authservice.domain.AuthClientDetails;
import com.ahlquist.authservice.domain.User;
import com.ahlquist.authservice.enums.Authorities;
