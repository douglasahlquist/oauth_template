...
public class MongoBeeConfig {
	...
	private static final String MONGODB_CHANGELOGS_PACKAGE = "com.ahlquist.authservice.config.mongodb.changelogs";
	...
	public Mongobee mongobee() {
		Mongobee runner = new Mongobee(
				String.format(MONGODB_URL_FORMAT, mongoProperties.getUsername(), mongoProperties.getPassword(),
